...
def get_lidar2imu_line(project_dir, lidar_name):
    ...
    para_dir = project_dir_parse.get_para_dir(project_dir)
    ...
    LidarParams = []
    vehicle_plate_number = project_dir_parse.get_vehicle_PlateNumber(
        project_dir)
...
def creat_lidar2imu_file(project_dir, lidar_name):
    ...
    lidar2imu_file_dir = project_dir + "/" + \
        project_dir_parse.get_project_name(project_dir) + "_" + lidar_name
...
# print(project_dir_parse.get_project_name(project_dir))
# print(project_dir_parse.get_para_dir(project_dir))
# print(project_dir_parse.get_vehicle_PlateNumber(project_dir))
